...
class TestBaseModelInstantiation(unittest.TestCase):
    """Test cases for instantiating the BaseModel class."""
    ...
    def test_str_representation(self):
        ...
        self.assertIn("[BaseModel] (123456)", obj_repr)
    ...
    def test_instantiation_with_kwargs(self):
        ...
        obj = BaseModel(id="345", created_at=date_time_iso,
    ...
    def test_instantiation_with_args_and_kwargs(self):
        ...
        date_time = datetime.today()
        date_time_iso = date_time.isoformat()
        obj = BaseModel("22", id="345", created_at=date_time_iso,
                        updated_at=date_time_iso)
        self.assertEqual(obj.id, "345")
        self.assertEqual(obj.created_at, date_time)
        self.assertEqual(obj.updated_at, date_time)
...
class TestBaseModelToDict(unittest.TestCase):
    """Test cases for converting BaseModel instances to dictionaries."""
